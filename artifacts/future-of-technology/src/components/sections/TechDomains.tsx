...
export default function TechDomains() {
  return (
    <section id="domains" className="py-24 relative bg-[#020617]">
          ...
          {CARDS.map((card, idx) => (
            ...
            >
              ...
              <div className="relative h-full flex flex-col glass-card rounded-2xl p-8 overflow-hidden border border-white/5 group-hover:border-white/20 transition-all duration-300 z-10">
                {/* Background glow orb */}
                <div 
                  className="absolute -top-10 -right-10 w-32 h-32 rounded-full opacity-20 blur-2xl transition-all duration-500 group-hover:scale-150 group-hover:opacity-40"
